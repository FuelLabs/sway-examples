const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BOr0s-O6.js","assets/index-o13GHUHZ.js","assets/index-D_7bBwnK.css"])))=>i.map(i=>d[i]);
import { p as proxy, l as subscribe, w as snapshot, _ as __vitePreload } from "./index-o13GHUHZ.js";
...
class d {
  ...
  async initUi() {
    if (typeof window < "u") {
      await __vitePreload(() => import("./index-BOr0s-O6.js"), true ? __vite__mapDeps([0,1,2]) : void 0);
