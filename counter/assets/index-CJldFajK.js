const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CHhzwrci.js","assets/index-CtQjFJW8.js","assets/index-BuD7DDRz.css"])))=>i.map(i=>d[i]);
import { p as proxy, l as subscribe, v as snapshot, _ as __vitePreload } from "./index-CtQjFJW8.js";
...
class d {
  ...
  async initUi() {
    if (typeof window < "u") {
      await __vitePreload(() => import("./index-CHhzwrci.js"), true ? __vite__mapDeps([0,1,2]) : void 0);
