const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-yTRbR1AO.js","assets/index-CtvMNVje.js","assets/index-DLhL4lUP.css"])))=>i.map(i=>d[i]);
import { p as proxy, l as subscribe, w as snapshot, _ as __vitePreload } from "./index-CtvMNVje.js";
...
class d {
  ...
  async initUi() {
    if (typeof window < "u") {
      await __vitePreload(() => import("./index-yTRbR1AO.js"), true ? __vite__mapDeps([0,1,2]) : void 0);
