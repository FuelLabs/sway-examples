const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-ChbihP_m.js","assets/index-CxPR0hVH.js","assets/index-C0mp6VS7.css"])))=>i.map(i=>d[i]);
import { p as proxy, l as subscribe, w as snapshot, _ as __vitePreload } from "./index-CxPR0hVH.js";
...
class d {
  ...
  async initUi() {
    if (typeof window < "u") {
      await __vitePreload(() => import("./index-ChbihP_m.js"), true ? __vite__mapDeps([0,1,2]) : void 0);
