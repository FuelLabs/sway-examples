const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-Bh53frrY.js","assets/index-uTjT8h2u.js","assets/index-DwZvhnNT.css"])))=>i.map(i=>d[i]);
import { p as proxy, l as subscribe, w as snapshot, _ as __vitePreload } from "./index-uTjT8h2u.js";
...
class d {
  ...
  async initUi() {
    if (typeof window < "u") {
      await __vitePreload(() => import("./index-Bh53frrY.js"), true ? __vite__mapDeps([0,1,2]) : void 0);
