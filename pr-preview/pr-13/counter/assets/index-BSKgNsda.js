const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BP3XCw-f.js","assets/index-C5dDsLaN.js","assets/index-DdiZ5lSc.css"])))=>i.map(i=>d[i]);
import { p as proxy, l as subscribe, w as snapshot, _ as __vitePreload } from "./index-C5dDsLaN.js";
...
class d {
  ...
  async initUi() {
    if (typeof window < "u") {
      await __vitePreload(() => import("./index-BP3XCw-f.js"), true ? __vite__mapDeps([0,1,2]) : void 0);
