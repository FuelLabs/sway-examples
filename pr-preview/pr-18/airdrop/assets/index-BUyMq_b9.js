import { ag as proxy, ah as subscribeKey, ai as subscribe, aj as ref, ak as OptionsController, al as i, am as customElement, an as r, ao as StorageUtil, ap as x, aq as r$1, ar as ModalController, as as EventsController, at as NetworkController, au as AccountController, av as W3mFrameRpcConstants, aw as SnackController, ax as ConnectionController, ay as RouterController } from "./index-pGglT_PI.js";
...
(function(e) {
  (function() {
    ...
    var o = !i2 && typeof self == "object", h = !n.JS_SHA3_NO_NODE_JS && typeof process == "object" && process.versions && process.versions.node;
    h ? n = On : o && (n = self);
    ...
    }, A = [{ name: "keccak", padding: S, bits: F, createMethod: Rt }, { name: "sha3", padding: I, bits: F, createMethod: Rt }, { name: "shake", padding: w, bits: U, createMethod: Yt }, { name: "cshake", padding: y, bits: U, createMethod: Y }, { name: "kmac", padding: y, bits: U, createMethod: Vt }], f = {}, a = [], c = 0; c < A.length; ++c) for (var d = A[c], g = d.bits, x2 = 0; x2 < g.length; ++x2) {
      var M = d.name + "_" + g[x2];
      if (a.push(M), f[M] = d.createMethod(g[x2], d.padding), d.name !== "sha3") {
        var l = d.name + g[x2];
        a.push(l), f[l] = f[M];
      }
    }
...
(function(e) {
  (function(t, r2) {
    ...
    o.isBN = function(f) {
      ...
      var g, x2, M = 0;
      if (c === "be") for (d = f.length - 1, g = 0; d >= 0; d -= 3) x2 = f[d] | f[d - 1] << 8 | f[d - 2] << 16, this.words[g] |= x2 << M & 67108863, this.words[g + 1] = x2 >>> 26 - M & 67108863, M += 24, M >= 26 && (M -= 26, g++);
      else if (c === "le") for (d = 0, g = 0; d < f.length; d += 3) x2 = f[d] | f[d + 1] << 8 | f[d + 2] << 16, this.words[g] |= x2 << M & 67108863, this.words[g + 1] = x2 >>> 26 - M & 67108863, M += 24, M >= 26 && (M -= 26, g++);
      return this._strip();
    };
    function p(A, f) {
    ...
    o.prototype._parseHex = function(f, a, c) {
      ...
      for (var d = 0; d < this.length; d++) this.words[d] = 0;
      var g = 0, x2 = 0, M;
      if (c === "be") for (d = f.length - 1; d >= a; d -= 2) M = b(f, a, d) << g, this.words[x2] |= M & 67108863, g >= 18 ? (g -= 18, x2 += 1, this.words[x2] |= M >>> 26) : g += 8;
      else {
        var l = f.length - a;
        for (d = l % 2 === 0 ? a + 1 : a; d < f.length; d += 2) M = b(f, a, d) << g, this.words[x2] |= M & 67108863, g >= 18 ? (g -= 18, x2 += 1, this.words[x2] |= M >>> 26) : g += 8;
      }
      this._strip();
    };
    function m(A, f, a, c) {
      for (var d = 0, g = 0, x2 = Math.min(A.length, a), M = f; M < x2; M++) {
    ...
    o.prototype._parseBase = function(f, a, c) {
      ...
      d--, g = g / a | 0;
      for (var x2 = f.length - c, M = x2 % d, l = Math.min(x2, x2 - M) + c, s = 0, v = c; v < l; v += d) s = m(f, v, v + d, a), this.imuln(g), this.words[0] + s < 67108864 ? this.words[0] += s : this._iaddn(s);
      if (M !== 0) {
        var k = 1;
    ...
    o.prototype.toString = function(f, a) {
      ...
      if (f === 16 || f === "hex") {
        c = "";
        for (var d = 0, g = 0, x2 = 0; x2 < this.length; x2++) {
          var M = this.words[x2], l = ((M << d | g) & 16777215).toString(16);
          g = M >>> 24 - d & 16777215, d += 2, d >= 26 && (d -= 26, x2--), g !== 0 || x2 !== this.length - 1 ? c = S[6 - l.length] + l + c : c = l + c;
        }
    ...
    o.prototype.toArrayLike = function(f, a, c) {
      ...
      var x2 = C(f, g), M = a === "le" ? "LE" : "BE";
      return this["_toArrayLike" + M](x2, d), x2;
    }, o.prototype._toArrayLikeLE = function(f, a) {
      for (var c = 0, d = 0, g = 0, x2 = 0; g < this.length; g++) {
        var M = this.words[g] << x2 | d;
      ...
      for (var c = f.length - 1, d = 0, g = 0, x2 = 0; g < this.length; g++) {
        var M = this.words[g] << x2 | d;
    ...
    o.prototype.zeroBits = function() {
      ...
      for (var g = 0, x2 = 0; x2 < d.length; x2++) a = (c.words[x2] | 0) + (d.words[x2] | 0) + g, this.words[x2] = a & 67108863, g = a >>> 26;
      for (; g !== 0 && x2 < c.length; x2++) a = (c.words[x2] | 0) + g, this.words[x2] = a & 67108863, g = a >>> 26;
      ...
      for (var x2 = 0, M = 0; M < g.length; M++) a = (d.words[M] | 0) - (g.words[M] | 0) + x2, x2 = a >> 26, this.words[M] = a & 67108863;
    ...
    function U(A, f, a) {
      ...
      a.length = c, c = c - 1 | 0;
      var d = A.words[0] | 0, g = f.words[0] | 0, x2 = d * g, M = x2 & 67108863, l = x2 / 67108864 | 0;
      a.words[0] = M;
      for (var s = 1; s < c; s++) {
        for (var v = l >>> 26, k = l & 67108863, u = Math.min(s, f.length - 1), E = Math.max(0, s - A.length + 1); E <= u; E++) {
          var _ = s - E | 0;
          d = A.words[_] | 0, g = f.words[E] | 0, x2 = d * g + k, v += x2 / 67108864 | 0, k = x2 & 67108863;
        }
        a.words[s] = k | 0, l = v | 0;
      }
    ...
    var J = function(f, a, c) {
      ...
      return M = (v + (s >>> 13) | 0) + (ui >>> 26) | 0, ui &= 67108863, x2[0] = Me, x2[1] = Ee, x2[2] = Se, x2[3] = Ne, x2[4] = Ie, x2[5] = Wr, x2[6] = Xr, x2[7] = Zr, x2[8] = $r, x2[9] = ti, x2[10] = ei, x2[11] = ri, x2[12] = ii, x2[13] = ni, x2[14] = fi, x2[15] = oi, x2[16] = si, x2[17] = ai, x2[18] = ui, M !== 0 && (x2[19] = M, c.length++), c;
    };
    Math.imul || (J = U);
    function Bt(A, f, a) {
    ...
    o.prototype.mulTo = function(f, a) {
      ...
      for (var c = 0, d = 0; d < this.length; d++) {
        var g = (this.words[d] | 0) * f, x2 = (g & 67108863) + (c & 67108863);
        c >>= 26, c += g / 67108864 | 0, c += x2 >>> 26, this.words[d] = x2 & 67108863;
      }
      ...
      if (a !== 0) {
        ...
        for (g = 0; g < this.length; g++) {
          ...
          this.words[g] = l | x2, x2 = M >>> 26 - a;
        }
        x2 && (this.words[g] = x2, this.length++);
      }
      if (c !== 0) {
      ...
      var d;
      a ? d = (a - a % 26) / 26 : d = 0;
      var g = f % 26, x2 = Math.min((f - g) / 26, this.length), M = 67108863 ^ 67108863 >>> g << g, l = c;
      ...
      for (g = 0; g < f.length; g++) {
        x2 = (this.words[g + c] | 0) + M;
        var l = (f.words[g] | 0) * a;
        x2 -= l & 67108863, M = (x2 >> 26) - (l / 67108864 | 0), this.words[g + c] = x2 & 67108863;
      }
      for (; g < this.length - c; g++) x2 = (this.words[g + c] | 0) + M, M = x2 >> 26, this.words[g + c] = x2 & 67108863;
      if (M === 0) return this._strip();
      for (i2(M === -1), M = 0, g = 0; g < this.length; g++) x2 = -(this.words[g] | 0) + M, M = x2 >> 26, this.words[g] = x2 & 67108863;
      return this.negative = 1, this._strip();
    }, o.prototype._wordDiv = function(f, a) {
      var c = this.length - f.length, d = this.clone(), g = f, x2 = g.words[g.length - 1] | 0, M = this._countBits(x2);
      c = 26 - M, c !== 0 && (g = g.ushln(c), d.iushln(c), x2 = g.words[g.length - 1] | 0);
      ...
      for (var u = l - 1; u >= 0; u--) {
        ...
        for (E = Math.min(E / x2 | 0, 67108863), d._ishlnsubmul(g, E, u); d.negative !== 0; ) E--, d.negative = 0, d._ishlnsubmul(g, 1, u), d.isZero() || (d.negative ^= 1);
        s && (s.words[u] = E);
      }
      ...
      var c = a.div.negative !== 0 ? a.mod.isub(f) : a.mod, d = f.ushrn(1), g = f.andln(1), x2 = c.cmp(d);
      return x2 < 0 || g === 1 && x2 === 0 ? a.div : a.div.negative !== 0 ? a.div.isubn(1) : a.div.iaddn(1);
      ...
      for (var d = new o(1), g = new o(0), x2 = new o(0), M = new o(1), l = 0; a.isEven() && c.isEven(); ) a.iushrn(1), c.iushrn(1), ++l;
      for (var s = c.clone(), v = a.clone(); !a.isZero(); ) {
        ...
        if (E > 0) for (c.iushrn(E); E-- > 0; ) (x2.isOdd() || M.isOdd()) && (x2.iadd(s), M.isub(v)), x2.iushrn(1), M.iushrn(1);
        a.cmp(c) >= 0 ? (a.isub(c), d.isub(x2), g.isub(M)) : (c.isub(a), x2.isub(d), M.isub(g));
      }
      ...
      var a = this, c = f.clone();
      a.negative !== 0 ? a = a.umod(f) : a = a.clone();
      for (var d = new o(1), g = new o(0), x2 = c.clone(); a.cmpn(1) > 0 && c.cmpn(1) > 0; ) {
        ...
        if (s > 0) for (c.iushrn(s); s-- > 0; ) g.isOdd() && g.iadd(x2), g.iushrn(1);
      ...
      for (var g = d, x2 = c; g !== 0 && x2 < this.length; x2++) {
        var M = this.words[x2] | 0;
        M += g, g = M >>> 26, M &= 67108863, this.words[x2] = M;
      }
      return g !== 0 && (this.words[x2] = g, this.length++), this;
    ...
    n(Pt, z), Pt.prototype.split = function(f, a) {
      ...
      var x2 = f.words[9];
      for (a.words[a.length++] = x2 & c, g = 10; g < f.length; g++) {
        var M = f.words[g] | 0;
        f.words[g - 10] = (M & c) << 4 | x2 >>> 22, x2 = M;
      }
      x2 >>>= 22, f.words[g - 10] = x2, x2 === 0 && f.length > 10 ? f.length -= 10 : f.length -= 9;
    ...
    Y.prototype._verify1 = function(f) {
      ...
      for (var v = this.pow(s, d), k = this.pow(f, d.addn(1).iushrn(1)), u = this.pow(f, d), E = g; u.cmp(x2) !== 0; ) {
      ...
      for (s === 0 && (s = 26), g = a.length - 1; g >= 0; g--) {
        for (var v = a.words[g], k = s - 1; k >= 0; k--) {
          ...
          M <<= 1, M |= u, l++, !(l !== c && (g !== 0 || k !== 0)) && (x2 = this.mul(x2, d[M]), l = 0, M = 0);
        }
        s = 26;
      }
      return x2;
    ...
    n(Vt, Y), Vt.prototype.convertTo = function(f) {
      ...
      var c = f.imul(a), d = c.maskn(this.shift).mul(this.minv).imaskn(this.shift).mul(this.m), g = c.isub(d).iushrn(this.shift), x2 = g;
      return g.cmp(this.m) >= 0 ? x2 = g.isub(this.m) : g.cmpn(0) < 0 && (x2 = g.iadd(this.m)), x2._forceRed(this);
    }, Vt.prototype.mul = function(f, a) {
      if (f.isZero() || a.isZero()) return new o(0)._forceRed(this);
      var c = f.mul(a), d = c.maskn(this.shift).mul(this.minv).imaskn(this.shift).mul(this.m), g = c.isub(d).iushrn(this.shift), x2 = g;
      return g.cmp(this.m) >= 0 ? x2 = g.isub(this.m) : g.cmpn(0) < 0 && (x2 = g.iadd(this.m)), x2._forceRed(this);
...
function be(e, t) {
  ...
  for (h.length > r2.length - 1 && Vn("fractional component exceeds decimals", "underflow", "parseFixed"), h === "" && (h = "0"); h.length < r2.length - 1; ) h += "0";
...
class Ut {
  ...
  static fromString(t, r2) {
    ...
    const h = Mi(n, i2.decimals);
    return new Ut(mr, o, h, i2);
  }
  static fromBytes(t, r2) {
    ...
    const o = n.toTwos((i2.signed ? 0 : 1) + i2.width).toHexString(), h = Mi(n, i2.decimals);
    return new Ut(mr, o, h, i2);
  }
  static from(t, r2) {
...
function ef(e, t) {
  t == null && (t = 1);
  const r2 = [], i2 = r2.forEach, n = function(o, h) {
    i2.call(o, function(p) {
      h > 0 && Array.isArray(p) ? n(p, h - 1) : r2.push(p);
    });
  };
  return n(e, t), r2;
}
...
function Pr(e, t) {
  ...
  for (let h = 0; h < i2; h++) for (let p = 0; p < o[h]; p++) r2.push(n[h] + p);
  return t ? r2.map((h) => t[h]) : r2;
}
function Q0(e) {
  let t = [];
  for (; ; ) {
...
function nf(e, t, r2) {
  ...
  for (let n = 0; n < t; n++) j0(e, r2).forEach((o, h) => i2[h].push(o));
  return i2;
}
function G0(e, t) {
...
function V0(e) {
  ...
  function r2() {
    ...
    n >>= 1;
    let p = n == 1, b = n == 2;
    return { branches: i2, valid: o, fe0f: h, save: p, check: b };
  }
}
function W0() {
...
function vs(e, t, r2, i2) {
  ...
  for (var o = new Array(n / 4), h = 0, p = t; h < o.length; h++, p += 4) {
    var b;
    i2 === "big" ? b = e[p] << 24 | e[p + 1] << 16 | e[p + 2] << 8 | e[p + 3] : b = e[p + 3] << 24 | e[p + 2] << 16 | e[p + 1] << 8 | e[p], o[h] = b >>> 0;
  }
  return o;
}
Q.join32 = vs;
...
function Ms(e, t, r2, i2) {
  var n = e[t], o = e[t + 1], h = i2 + o >>> 0, p = (h < i2 ? 1 : 0) + r2 + n;
  e[t] = p >>> 0, e[t + 1] = h;
}
Q.sum64 = Ms;
...
Q.sum64_4_hi = Ns;
function Is(e, t, r2, i2, n, o, h, p) {
  var b = t + i2 + o + p;
  return b >>> 0;
}
Q.sum64_4_lo = Is;
function _s(e, t, r2, i2, n, o, h, p, b, m) {
  var w = 0, y = t;
...
Q.sum64_5_hi = _s;
function Bs(e, t, r2, i2, n, o, h, p, b, m) {
  var w = t + i2 + o + p + m;
  return w >>> 0;
}
Q.sum64_5_lo = Bs;
...
he.blockSize = 512, he.outSize = 160, he.hmacStrength = 80, he.padLength = 64, he.prototype._update = function(t, r2) {
  ...
  for (n = 0; n < i2.length; n++) {
    var w = ~~(n / 20), y = Ls(_i(o, 5), js(w, h, p, b), m, i2[n], Qs[w]);
...
ce.blockSize = 512, ce.outSize = 256, ce.hmacStrength = 192, ce.padLength = 64, ce.prototype._update = function(t, r2) {
  ...
  for (Ys(this.k.length === i2.length), n = 0; n < i2.length; n++) {
    var I = Ws(S, ta(m), Xs(m, w, y), this.k[n], i2[n]), N = ie($s(o), Zs(o, h, p));
...
ne.blockSize = 1024, ne.outSize = 512, ne.hmacStrength = 192, ne.padLength = 128, ne.prototype._prepareBlock = function(t, r2) {
  ...
  for (; n < i2.length; n += 2) {
    var o = xa(i2[n - 4], i2[n - 3]), h = Ma(i2[n - 4], i2[n - 3]), p = i2[n - 14], b = i2[n - 13], m = ya(i2[n - 30], i2[n - 29]), w = wa(i2[n - 30], i2[n - 29]), y = i2[n - 32], S = i2[n - 31];
    i2[n] = sa(o, h, p, b, m, w, y, S), i2[n + 1] = aa(o, h, p, b, m, w, y, S);
  }
}, ne.prototype._update = function(t, r2) {
  this._prepareBlock(t, r2);
  var i2 = this.W, n = this.h[0], o = this.h[1], h = this.h[2], p = this.h[3], b = this.h[4], m = this.h[5], w = this.h[6], y = this.h[7], S = this.h[8], I = this.h[9], N = this.h[10], C = this.h[11], F = this.h[12], U = this.h[13], J = this.h[14], Bt = this.h[15];
...
Xe.inherits(pe, _f), Sf.ripemd160 = pe, pe.blockSize = 512, pe.outSize = 160, pe.hmacStrength = 192, pe.padLength = 64, pe.prototype._update = function(t, r2) {
  for (var i2 = this.h[0], n = this.h[1], o = this.h[2], h = this.h[3], p = this.h[4], b = i2, m = n, w = o, y = h, S = p, I = 0; I < 80; I++) {
    var N = Nf(Tr(If(i2, Bf(I, n, o, h), t[_a[I] + r2], Na(I)), Ca[I]), p);
    i2 = p, p = h, h = Tr(o, 10), o = n, n = N, N = Nf(Tr(If(b, Bf(79 - I, m, w, y), t[Ba[I] + r2], Ia(I)), Ra[I]), S), b = S, S = y, y = Tr(w, 10), w = m, m = N;
  }
  N = xr(this.h[1], o, y), this.h[1] = xr(this.h[2], h, S), this.h[2] = xr(this.h[3], p, b), this.h[3] = xr(this.h[4], i2, m), this.h[4] = xr(this.h[0], n, w), this.h[0] = N;
...
Ce.prototype.point = function() {
  ...
  for (var w = this.jpoint(null, null, null), y = this.jpoint(null, null, null), S = o; S > 0; S--) {
    for (p = 0; p < h.length; p++) b = h[p], b === S ? y = y.mixedAdd(i2.points[p]) : b === -S && (y = y.mixedAdd(i2.points[p].neg()));
    w = w.add(y);
  }
  return w.toP();
  ...
  i2 = n.wnd;
  for (var o = n.points, h = Ur(r2, i2, this._bitLength), p = this.jpoint(null, null, null), b = h.length - 1; b >= 0; b--) {
  ...
  for (w = n - 1; w >= 1; w -= 2) {
    var N = w - 1, C = w;
    if (h[N] !== 1 || h[C] !== 1) {
      b[N] = Ur(i2[N], h[N], this._bitLength), b[C] = Ur(i2[C], h[C], this._bitLength), m = Math.max(b[N].length, m), m = Math.max(b[C].length, m);
      continue;
    }
...
Zt.prototype._getEndomorphism = function(t) {
  if (!(!this.zeroA || !this.g || !this.n || this.p.modn(3) !== 1)) {
    ...
    }) : h = this._getEndoBasis(i2), { beta: r2, lambda: i2, basis: h };
  }
}, Zt.prototype._getEndoRoots = function(t) {
  var r2 = t === this.p ? this.red : K.mont(t), i2 = new K(2).toRed(r2).redInvm(), n = i2.redNeg(), o = new K(3).toRed(r2).redNeg().redSqrt().redMul(i2), h = n.redAdd(o).fromRed(), p = n.redSub(o).fromRed();
  return [h, p];
}, Zt.prototype._getEndoBasis = function(t) {
  for (var r2 = this.n.ushrn(Math.floor(this.n.bitLength() / 2)), i2 = t, n = this.n.clone(), o = new K(1), h = new K(0), p = new K(0), b = new K(1), m, w, y, S, I, N, C, F = 0, U, J; i2.cmpn(0) !== 0; ) {
    var Bt = n.div(i2);
    U = n.sub(Bt.mul(i2)), J = p.sub(Bt.mul(o));
    var G = b.sub(Bt.mul(h));
    if (!y && U.cmp(r2) < 0) m = C.neg(), w = o, y = U.neg(), S = J;
    else if (y && ++F === 2) break;
    C = U, n = i2, i2 = U, p = o, o = J, b = h, h = G;
  }
  I = U.neg(), N = J;
  ...
  var r2 = this.endo.basis, i2 = r2[0], n = r2[1], o = n.b.mul(t).divRound(this.n), h = i2.b.neg().mul(t).divRound(this.n), p = o.mul(i2.a), b = h.mul(n.a), m = o.mul(i2.b), w = h.mul(n.b), y = t.sub(p).sub(b), S = m.add(w).neg();
  return { k1: y, k2: S };
...
Di(Ft, Ze.BasePoint), Zt.prototype.point = function(t, r2, i2) {
  ...
  var r2 = this.curve.a, i2 = this.x.redSqr(), n = t.redInvm(), o = i2.redAdd(i2).redIAdd(i2).redIAdd(r2).redMul(n), h = o.redSqr().redISub(this.x.redAdd(this.x)), p = o.redMul(this.x.redSub(h)).redISub(this.y);
...
Di(Tt, Ze.BasePoint), Zt.prototype.jpoint = function(t, r2, i2) {
  ...
  var r2 = t.z.redSqr(), i2 = this.z.redSqr(), n = this.x.redMul(r2), o = t.x.redMul(i2), h = this.y.redMul(r2.redMul(t.z)), p = t.y.redMul(i2.redMul(this.z)), b = n.redSub(o), m = h.redSub(p);
  ...
  if (t.isInfinity()) return this;
  var r2 = this.z.redSqr(), i2 = this.x, n = t.x.redMul(r2), o = this.y, h = t.y.redMul(r2).redMul(this.z), p = i2.redSub(n), b = o.redSub(h);
  ...
  for (r2 = 0; r2 < t; r2++) {
    ...
    var Bt = w.redMul(b);
    r2 + 1 < t && (m = m.redMul(I)), h = F, b = Bt, w = J;
  }
  ...
  var t = this.curve.a, r2 = this.x, i2 = this.y, n = this.z, o = n.redSqr().redSqr(), h = r2.redSqr(), p = i2.redSqr(), b = h.redAdd(h).redIAdd(h).redIAdd(t.redMul(o)), m = r2.redAdd(r2);
  m = m.redIAdd(m);
  ...
  var t = this.x.redSqr(), r2 = this.y.redSqr(), i2 = this.z.redSqr(), n = r2.redSqr(), o = t.redAdd(t).redIAdd(t), h = o.redSqr(), p = this.x.redAdd(r2).redSqr().redISub(t).redISub(n);
  p = p.redIAdd(p), p = p.redAdd(p).redIAdd(p), p = p.redISub(h);
  var b = p.redSqr(), m = n.redIAdd(n);
  m = m.redIAdd(m), m = m.redIAdd(m), m = m.redIAdd(m);
  var w = o.redIAdd(p).redSqr().redISub(h).redISub(b).redISub(m), y = r2.redMul(w);
...
Re.prototype._init = function(t, r2, i2) {
  ...
  var h = o.slice(0, t);
  return this._update(i2), this._reseed++, fe.encode(h, r2);
};
var Fi = Jt.assert;
function kt(e, t) {
...
function Ui(e, t) {
  ...
  for (var n = 0, o = 0, h = t.place; o < i2; o++, h++) n <<= 8, n |= e[h], n >>>= 0;
...
Hr.prototype._importDER = function(t, r2) {
  ...
  var h = t.slice(i2.place, o + i2.place);
...
$t.prototype.keyPair = function(t) {
  ...
  for (var o = this.n.byteLength(), h = r2.getPrivate().toArray("be", o), p = t.toArray("be", o), b = new Rf({ hash: this.hash, entropy: h, nonce: p, pers: n.pers, persEnc: n.persEnc || "utf8" }), m = this.n.sub(new K(1)), w = 0; ; w++) {
  ...
  var n = this.n, o = new K(e), h = t.r, p = t.s, b = r2 & 1, m = r2 >> 1;
...
let W3mConnectingSiwe = class W3mConnectingSiwe2 extends r {
  constructor() {
    var _a2;
    super(...arguments);
...
let W3mConnectingSiweView = class W3mConnectingSiweView2 extends r {
  constructor() {
    var _a2;
    super(...arguments);
