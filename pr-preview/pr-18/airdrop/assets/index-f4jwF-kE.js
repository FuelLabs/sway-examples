const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BybM-qLE.js","assets/index-CUJp9d5D.js","assets/index-CvaSZn0p.css"])))=>i.map(i=>d[i]);
import { bf as proxy, bh as subscribe, d2 as snapshot, f as __vitePreload } from "./index-CUJp9d5D.js";
const state$7 = proxy({
...
class WalletConnectModal {
  ...
  async initUi() {
    if (typeof window !== "undefined") {
      await __vitePreload(() => import("./index-BybM-qLE.js"), true ? __vite__mapDeps([0,1,2]) : void 0);
