import { z as or, A as useMutation, D as _t, y as useQuery, a7 as Provider, a8 as NODE_URL, c as createLazyFileRoute, j as jsxRuntimeExports, a9 as useParams, r as reactExports, a6 as DateTime } from "./index-m4XAuUiK.js";
import { d as TestContract, B as Button, a as createMerkleTree, g as generateProof } from "./button-D1iGlVVX.js";
...
function ClaimAirdrop() {
  ...
  reactExports.useEffect(() => {
    ...
    if (recipients && wallet) {
      recipients == null ? void 0 : recipients.find((recipient2, index) => {
        const temp = recipient2.address.toLowerCase() === wallet.address.toHexString();
        if (temp) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full text-center flex flex-col justify-center", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Text, { textAlign: "center", children: [
        "Contract Owner: ",
        (_a = owner == null ? void 0 : owner.Address) == null ? void 0 : _a.bits
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Text, { textAlign: "center", children: [
        "End time:",
        " ",
