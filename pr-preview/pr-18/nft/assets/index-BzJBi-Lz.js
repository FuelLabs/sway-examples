const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BU8TJ8RE.js","assets/index-DpUPC9av.js","assets/index-DTckpRkJ.css"])))=>i.map(i=>d[i]);
import { p as proxy, l as subscribe, w as snapshot, _ as __vitePreload } from "./index-DpUPC9av.js";
...
class d {
  ...
  async initUi() {
    if (typeof window < "u") {
      await __vitePreload(() => import("./index-BU8TJ8RE.js"), true ? __vite__mapDeps([0,1,2]) : void 0);
