const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CXAlJGph.js","assets/index-DNFudrio.js","assets/index-srLX7Xlb.css"])))=>i.map(i=>d[i]);
import { p as proxy, l as subscribe, v as snapshot, _ as __vitePreload } from "./index-DNFudrio.js";
...
class d {
  ...
  async initUi() {
    if (typeof window < "u") {
      await __vitePreload(() => import("./index-CXAlJGph.js"), true ? __vite__mapDeps([0,1,2]) : void 0);
