const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BpULMzeg.js","assets/index-9i5oOEc3.js","assets/index-C0xp_EqN.css"])))=>i.map(i=>d[i]);
import { p as proxy, l as subscribe, w as snapshot, _ as __vitePreload } from "./index-9i5oOEc3.js";
...
class d {
  ...
  async initUi() {
    if (typeof window < "u") {
      await __vitePreload(() => import("./index-BpULMzeg.js"), true ? __vite__mapDeps([0,1,2]) : void 0);
