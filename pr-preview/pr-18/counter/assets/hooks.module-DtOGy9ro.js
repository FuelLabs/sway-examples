import { a as eventsExports, h as buffer, i as require$$3, c as commonjsGlobal, j as inherits_browserExports, s as safeBufferExports, d as getAugmentedNamespace } from "./index-DDSUG89u.js";
...
function L(n2, l2, u2, t2) {
  ...
  if (("function" != typeof o2 || o2 === b$1 || i2) && t2 > (null != e2 && 0 == (131072 & e2.__u) ? 1 : 0)) for (; r2 >= 0 || f2 < l2.length; ) {
    if (r2 >= 0) {
...
function z$1(u2, t2, i2, o2, r2, f2, e2, c2, s2) {
  ...
  if (null === C2) b2 === k2 || c2 && u2.data === k2 || (u2.data = k2);
    ...
    else if (p2 && (u2.innerHTML = ""), P$1(u2, y$1(d2) ? d2 : [d2], t2, i2, o2, "foreignObject" === C2 ? "http://www.w3.org/1999/xhtml" : r2, f2, e2, f2 ? f2[0] : i2.__k && x$1(i2, 0), c2, s2), null != f2) for (a2 = f2.length; a2--; ) w$1(f2[a2]);
