const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DgOMk3G6.js","assets/index-DTpmsGsh.js","assets/index-BEoFaTsn.css"])))=>i.map(i=>d[i]);
import { p as proxy, l as subscribe, w as snapshot, _ as __vitePreload } from "./index-DTpmsGsh.js";
...
class d {
  ...
  async initUi() {
    if (typeof window < "u") {
      await __vitePreload(() => import("./index-DgOMk3G6.js"), true ? __vite__mapDeps([0,1,2]) : void 0);
