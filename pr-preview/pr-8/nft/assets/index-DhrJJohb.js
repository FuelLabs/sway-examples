const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BcSt1-Av.js","assets/index-Ct6V0yYN.js","assets/index-BEoFaTsn.css"])))=>i.map(i=>d[i]);
import { p as proxy, l as subscribe, w as snapshot, _ as __vitePreload } from "./index-Ct6V0yYN.js";
...
class d {
  ...
  async initUi() {
    if (typeof window < "u") {
      await __vitePreload(() => import("./index-BcSt1-Av.js"), true ? __vite__mapDeps([0,1,2]) : void 0);
