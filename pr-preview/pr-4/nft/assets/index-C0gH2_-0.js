const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CWJd2v6I.js","assets/index-BOITX363.js","assets/index-lYfrEFEg.css"])))=>i.map(i=>d[i]);
import { p as proxy, l as subscribe, w as snapshot, _ as __vitePreload } from "./index-BOITX363.js";
...
class d {
  ...
  async initUi() {
    if (typeof window < "u") {
      await __vitePreload(() => import("./index-CWJd2v6I.js"), true ? __vite__mapDeps([0,1,2]) : void 0);
