import { c as createLazyFileRoute, j as jsxRuntimeExports, u as useActiveWallet, a as useNavigate, T as Text, B as Button, b as checkEligibility, g as getTruncatedAddress } from "./index-ak7IdLli.js";
import { u as useGetAirdropData, F as FuelLogo, G as Grid, B as Badge, A as ArrowRight } from "./badge-mD7aVoQ4.js";
import { C as Card, a as CardHeader, b as CardTitle, c as CardContent, d as CardFooter } from "./card-hVTNnJvf.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full", children: [
      ...
      !isFetching && !isError && airdropData && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center mb-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { variant: "h6", className: "text-xl font-semibold text-foreground", children: "Available Airdrops" }) }),
