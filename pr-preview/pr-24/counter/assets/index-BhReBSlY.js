const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-cWhZardG.js","assets/index-Dg_2j3rg.js","assets/index-BuD7DDRz.css"])))=>i.map(i=>d[i]);
import { p as proxy, l as subscribe, v as snapshot, _ as __vitePreload } from "./index-Dg_2j3rg.js";
...
class d {
  ...
  async initUi() {
    if (typeof window < "u") {
      await __vitePreload(() => import("./index-cWhZardG.js"), true ? __vite__mapDeps([0,1,2]) : void 0);
