import { n as ne$1, s as se$1, T as T$2, t as te$1, a as a$2, o as oe$1, R as R$1, p as p$1, y as y$1 } from "./index-DgZwjKxf.js";
import { w as b$1, b4 as browser } from "./index-N0KDD3ZO.js";
/**
 * @license
...
const Dt = { generate(e2, o3, r2) {
  ...
  $2.forEach(({ x: y2, y: u3 }) => {
    const O = (i2.length - A) * s2 * y2, b$12 = (i2.length - A) * s2 * u3, E2 = 0.45;
    for (let M2 = 0; M2 < $2.length; M2 += 1) {
      const V2 = s2 * (A - M2 * 2);
      l2.push(b`<rect fill="${M2 % 2 === 0 ? a2 : t2}" height="${V2}" rx="${V2 * E2}" ry="${V2 * E2}" width="${V2}" x="${O + s2 * M2}" y="${b$12 + s2 * M2}">`);
    }
  });
  ...
  return Se.forEach(([y2, u3]) => {
    ...
    u3.forEach(([O, b$12]) => {
      l2.push(b`<line x1="${y2}" x2="${y2}" y1="${O}" y2="${b$12}" stroke="${a2}" stroke-width="${s2 / (Ve / 2)}" stroke-linecap="round">`);
    });
  }), l2;
