const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BCPJWWgi.js","assets/index-oSWd6EMR.js","assets/index-DS-fTlcp.css"])))=>i.map(i=>d[i]);
import { p as proxy, l as subscribe, w as snapshot, _ as __vitePreload } from "./index-oSWd6EMR.js";
...
class d {
  ...
  async initUi() {
    if (typeof window < "u") {
      await __vitePreload(() => import("./index-BCPJWWgi.js"), true ? __vite__mapDeps([0,1,2]) : void 0);
