import { r as reactExports, R as React, h as clsx, z as useForkRef, e as generateUtilityClass, g as generateUtilityClasses, s as styled, A as capitalize, m as memoTheme, f as useDefaultProps, j as jsxRuntimeExports, i as composeClasses, G as _inheritsLoose, H as ReactDOM, I as _objectWithoutPropertiesLoose, J as ReactExports, K as TransitionGroupContext, M as useEnhancedEffect, N as setRef, O as reactDomExports, Q as formatMuiErrorMessage, S as useEventCallback, U as rootShouldForwardProp, V as createSimplePaletteValueFilter, W as deepmerge, X as useTimeout, Y as slotShouldForwardProp } from "./index-rU4hKwMW.js";
import { g as globalCss } from "./index-vDvRx7kw.js";
import { a as useTheme, P as Paper, u as useThemeProps } from "./Paper-BM-MaxmW.js";
...
const Input = ({ value, onChange, placeholder, className, type, id }) => {
...
const MultilineInput = ({ value, onChange, placeholder, className, type, maxRows }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    TextField,
    {
      value,
