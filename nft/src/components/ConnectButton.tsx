...
import { Button as MuiButton, ListItemIcon, ListItemText, Menu, MenuItem, styled } from "@mui/material";
...
export const ConnectButton = ({ showTopUpButton, onTopUp }: ConnectButtonProps) => {
