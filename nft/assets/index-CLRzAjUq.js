const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-Euyx3Rtn.js","assets/index-nppx81QQ.js","assets/index-CketZTkf.css"])))=>i.map(i=>d[i]);
import { p as proxy, l as subscribe, v as snapshot, _ as __vitePreload } from "./index-nppx81QQ.js";
...
class d {
  ...
  async initUi() {
    if (typeof window < "u") {
      await __vitePreload(() => import("./index-Euyx3Rtn.js"), true ? __vite__mapDeps([0,1,2]) : void 0);
