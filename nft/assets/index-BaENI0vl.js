const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BhLvW2kq.js","assets/index-DCYGgmqm.js","assets/index-D6HFGFQx.css"])))=>i.map(i=>d[i]);
import { p as proxy, l as subscribe, w as snapshot, _ as __vitePreload } from "./index-DCYGgmqm.js";
...
class d {
  ...
  async initUi() {
    if (typeof window < "u") {
      await __vitePreload(() => import("./index-BhLvW2kq.js"), true ? __vite__mapDeps([0,1,2]) : void 0);
